...
class ExchangeInterface:
    ...
    def cancel_bulk_orders(self, orders):
        if self.dry_run:
            return orders
        return self.bitmex.cancelclordid(orders)

    def place_order(self,quantity,price,clOrdID):
        return self.bitmex.place_order(quantity,price,clOrdID)
    
    def cancel_order(self,clOrdID):
        return self.bitmex.cancelclordid(clOrdID)
...
class OrderManager:
    ...
    def converge_orders(self, buy_orders, sell_orders):
        ...
        #         print(desired_order['orderQty'])
        #         print(order['leavesQty'])
        #         print(desired_order['price'])
        #         print(order['price'])
        ...
        if len(to_create) > 0:
            ...
            order_ids = self.exchange.create_bulk_orders(to_create)
